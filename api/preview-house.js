...
// Singleton, no slug — same shape as api/preview-writer.js minus the
// slug parameter, since houseContent has exactly one document and both
// The House and its Submission Guidelines page fetch it whole.
...
export default async function handler(req, res) {
  ...
  try {
    const result = await client.fetch(`*[_type == "houseContent"][0]`);
